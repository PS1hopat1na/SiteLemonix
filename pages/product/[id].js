...
export default function ProductPage({ product, recommendations, reviews, avg_rating }) {
  ...
  if (!product) {
    return (
      <div style={{ color: "red", fontWeight: 700, fontSize: 24, margin: 40 }}>
        Товар не найден
      </div>
    );
  }
      ...
      <div className="product-main">
        ...
        <div className="product-info-dns">
          ...
          <div className="product-price-block">
            ...
            <button
              className="btn-dns-buy add-to-cart-btn"
              type="button"
          ...
          <div className="product-rating-block">
            <b>Средний рейтинг:</b>{" "}
            {avg_rating > 0 ? (
              <span className="product-rating">{avg_rating} ★</span>
            ) : (
              ...
              <div className="review-user-content">
                <div className="review-user-header">
                  <span className="review-username">
                    {review.user_phone || "Пользователь"}
                  </span>
